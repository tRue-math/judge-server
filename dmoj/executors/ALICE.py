...
class Executor(ScriptExecutor):
    ext = 'alice'
    address_grace = 65536
    test_program = '"!dlroW ,olleH :ohce"d&O@'
    nproc = -1
    command_paths = (
        ['ruby']
    ...
    fs = [ExactFile('/proc/self/loginuid'), RecursiveDir('/opt/alice'), RecursiveDir('/var/lib/gems'),ExactDir('/var'),ExactDir('/var/lib')]
    ...
    def get_cmdline(self, **kwargs) -> List[str]:
        ...
        return [command, '/opt/alice/interpreter.rb', self._code]
